const collectionsModule = () => {
    const collections = document.querySelectorAll('[data-carrousel="collection"]')
...
const insertCollectionData = (collection) => {
    collectionData.push ({
        carouselList: collection.querySelector('[data-carrousel="list"]'),
        carouselItem: collection.querySelectorAll('[data-carrousel="item"]'),
        btnPrevious: collection.querySelector('[data-carrousel="btn-previous"]'),
        btnNext: collection.querySelector('[data-carrousel="btn-next"]'),
