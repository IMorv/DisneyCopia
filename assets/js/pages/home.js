...
const Home = (data) => {
    ...
    const collectionsElement = document.querySelector('[data-carrousel="collections"]')
    ...
    for (const category of categories) {
        ...
        const movieCarouselListElement = collectionElement.querySelector('[data-carrousel="list"]')
